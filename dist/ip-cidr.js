...
class IPCIDR {
  ...
  contains(address) {
    try {
      if (!(address instanceof _ipAddress.Address6) && !(address instanceof _ipAddress.Address4)) {
...
IPCIDR.createAddress = function (val) {
  ...
  const ipAddressType = val.match(":") ? _ipAddress.Address6 : _ipAddress.Address4;
  let ip = new ipAddressType(val);
  if (ip.v4 && val.match(":") && ip.address) {
    ip = ip.address;
  }
  if (ip.v4) {
...
var _default = exports.default = IPCIDR;

},{"ip-address":5}],2:[function(require,module,exports){
"use strict";
...
},{"./address-error":3,"./ipv4":6,"./ipv6":7,"./v6/helpers":10}],6:[function(require,module,exports){
"use strict";
